...
if not os.path.exists("{}/kondate.db".format(DB_DIR)):
    ...
    cur = connect.cursor()
    cur.execute("CREATE TABLE breakfast (date INTEGER PRIMARY KEY, menu_list TEXT NOT NULL, nutritive_list TEXT NOT NULL);")
    cur.execute("CREATE TABLE lunch (date INTEGER PRIMARY KEY, menu_list TEXT NOT NULL, nutritive_list TEXT NOT NULL);")
    cur.execute("CREATE TABLE dinner (date INTEGER PRIMARY KEY, menu_list TEXT NOT NULL, nutritive_list TEXT NOT NULL);")
    connect.commit()
    cur.close()
    connect.close()
